Personal project management app being used as a proof of concept/teaching tool for UDF (unidirectional data flow) patterns for UI development

Projector was born out of 3 needs:

1. Needing a project to use for learning Claude Code
2. Needing a project to test a minimal UDF approach
3. Trying to keep track of the increasing number of things I was dropping the ball on.
